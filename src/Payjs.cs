...
namespace PayJSDemo
{
    class Payjs
    {
        private string[] apiList = new string[] { "native", "cashier", "jsapi", "micropay", "facepay","refund", "close", "user", "info", "mweb", "reverse", "complaint", "bank"};
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public string mweb(Dictionary<string, string> param)
        {
            string url = this.apiUrl[MethodBase.GetCurrentMethod().Name];
            return this.post(url, param);
        }
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public string reverse(Dictionary<string, string> param)
        {
            string url = this.apiUrl[MethodBase.GetCurrentMethod().Name];
            return this.post(url, param);
        }
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public string bank(Dictionary<string, string> param)
        {
            string url = this.apiUrl[MethodBase.GetCurrentMethod().Name];
            return this.post(url, param);
        }
